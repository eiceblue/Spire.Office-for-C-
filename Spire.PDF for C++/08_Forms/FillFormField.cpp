...
int main()
{
	...
	wstring inputFile = input_path + L"FillFormField.pdf";
	wstring output_path = OUTPUTPATH;
	wstring outputFile = output_path + L"FillFormField.pdf";
	...
	for (int i = 0; i < formWidget->GetFieldsWidget()->GetCount(); i++)
	{
		...
		{
			intrusive_ptr<PdfButtonWidgetFieldWidget> btnField = Object::Convert<PdfButtonWidgetFieldWidget>(field);
